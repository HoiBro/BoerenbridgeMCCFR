...
def exploit(suits, ranks, hand_size, train_iterations, intervals, eval_iterations):
    """
...
def abstraction_func(suits, ranks, hand_size, train_iterations, intervals, eval_iterations, abstraction):
    """
