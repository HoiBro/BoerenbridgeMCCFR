...
def exploit_plotter(suits, ranks, hand_size, train_iterations, intervals, eval_iterations, runs):
    """
...
def abstraction_plotter(suits, ranks, hand_size, train_iterations, intervals, eval_iterations, abstraction, runs):
    """
    train_iterations: total number of iterations
    interval: number of intevals for eval
    eval_iteration: number of iterations for each eval
...
def full_abstraction_plotter(suits, ranks, hand_size, train_iterations, intervals, eval_iterations, runs):
    """
    train_iterations: total number of iterations
    interval: number of intevals for eval
    eval_iteration: number of iterations for each eval
