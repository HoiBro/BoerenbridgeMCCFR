...
def exploit_plotter(suits, ranks, hand_size, starting_iterations, train_iterations, intervals, eval_iterations, name, runs):
    ...
    plt.plot(n_plot, mean, label='Gemiddelde', color='r')
    plt.legend(bbox_to_anchor=(0.75, 1.1), ncol=2, frameon=False)
    plt.title(f"Exploiteerbaarheid voor spel", y=1.1)
...
def abstraction_plotter(suits, ranks, hand_size, train_iterations, intervals, eval_iterations, name, abstraction, runs, s):
    ...
    plt.legend(bbox_to_anchor=(0.75, 1.1), ncol=2, frameon=False)
    plt.title(f"Gemiddelde score tegen niet abstracte strategie", y=1.1)
    plt.xlabel('Iteraties')
...
def full_abstraction_plotter(suits, ranks, hand_size, train_iterations, intervals, eval_iterations, name, abstractions, runs, s):
    ...
    if abstractions[0]:
        ...
        plt.plot(n_plot, results_mean_naive, label='result_naive_gem', color='r')
        if s:
            ...
            plt.plot(n_plot, score_mean_naive, label='score_naive_gem', color='m')
    ...
    if abstractions[1]:
        ...
        plt.plot(n_plot, results_mean_sim, label='result_sim_gem', color='purple')
        if s:
            ...
            plt.plot(n_plot, score_mean_sim, label='score_sim_gem', color='mediumvioletred')
    ...
    if abstractions[2]:
        ...
        plt.plot(n_plot, results_mean_simh, label='result_simhand_gem', color='y')
        if s:
            ...
            plt.plot(n_plot, score_mean_simh, label='score_simhand_gem', color='orange')
    ...
    if abstractions[3]:
        ...
        plt.plot(n_plot, results_mean_bets, label='result_bets_gem', color='g')
        if s:
            ...
            plt.plot(n_plot, score_mean_bets, label='score_bets_gem', color='lime')
    ...
    if abstractions[4]:
        ...
        plt.plot(n_plot, results_mean_suit, label='result_suit_gem', color='b')
        if s:
            ...
            plt.plot(n_plot, score_mean_suit, label='score_suit_gem', color='turquoise')
    ...
    if abstractions[5]:
        ...
        plt.plot(n_plot, results_mean_suitbet, label='result_suitbet_gem', color='teal')
        if s:
            ...
            plt.plot(n_plot, score_mean_suitbet, label='score_suitbet_gem', color='mediumseagreen')
    ...
    if abstractions[6]:
        ...
        plt.plot(n_plot, results_mean_adv, label='result_adv_gem', color='c')
        if s:
            ...
            plt.plot(n_plot, score_mean_adv, label='score_adv_gem', color='lightskyblue')


    plt.legend(bbox_to_anchor=(1, 1.1), ncol=8, frameon=False)
    plt.title(f"Gemiddelde score tegen de niet abstracte strategie", y=1.1)
    plt.xlabel('Iteraties')
    plt.ylabel('Gemiddelde score')
